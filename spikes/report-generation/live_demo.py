...
h1{font-size:32px;margin:0 0 8px}h2{margin-top:0}.lead{color:#52606d}.panel{background:white;border:1px solid #dfe3e8;border-radius:14px;padding:22px;margin-top:18px;box-shadow:0 5px 18px #1822300c}
label{font-weight:700;display:block;margin-bottom:9px}textarea{width:100%;min-height:92px;resize:vertical;border:1px solid #aab4c0;border-radius:9px;padding:13px;font:inherit}button{border:0;border-radius:8px;padding:11px 18px;font-weight:700;cursor:pointer;background:#185adb;color:white}.secondary{background:#e8eef9;color:#174ea6}
.actions,.examples{display:flex;gap:10px;flex-wrap:wrap;align-items:center;margin-top:12px}.examples button{background:#e8eef9;color:#174ea6;padding:7px 10px}.cost{color:#8a4b08;font-size:13px}.progress-head{display:flex;align-items:center;justify-content:space-between;gap:12px}.progress-head h2{margin:0}.status-pill{padding:5px 10px;border-radius:999px;background:#edf1f5;color:#52606d;font-size:13px;font-weight:700}.stages{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;list-style:none;margin:18px 0 0;padding:0}.stages li{min-height:78px;padding:12px;border:1px solid #dfe3e8;border-radius:10px;background:#f7f9fb;color:#617184}.stages strong,.stages span{display:block}.stages span{font-size:12px;margin-top:6px}.stages .active{border-color:#e9b949;background:#fff8e6;color:#704d00}.stages .done{border-color:#75c98a;background:#eefaf1;color:#176b32}
...
.metric{font-size:48px;font-weight:750;padding:26px 8px}.chart{overflow-x:auto}.chart svg{min-width:680px;width:100%;height:auto}.chart text{font-size:12px;fill:#475569}table{border-collapse:collapse;width:100%}th,td{border-bottom:1px solid #e5e9ee;padding:9px;text-align:left}th{background:#f7f9fb}dialog{width:min(560px,calc(100% - 32px));border:0;border-radius:14px;padding:0;box-shadow:0 24px 70px #18223040}dialog::backdrop{background:#18223080}.dialog-body{padding:24px}.cost-list{padding-left:22px;line-height:1.8}.dialog-actions{display:flex;justify-content:flex-end;gap:10px;margin-top:22px}@media(max-width:760px){.grid,.stages{grid-template-columns:1fr}.progress-head{align-items:flex-start}h1{font-size:26px}}
</style></head><body><main class="wrap"><h1>日本語からSQLとグラフを生成</h1>
<p class="lead">質問に応じてAIがSQLを作り、安全検査後にBigQueryで実行し、結果をグラフまたは表にする4段階を確認できます。</p>
...
<p class="lead">ローカルデモです。本番の認証・gate・executor・顧客Git配送は通りません。</p></main>
