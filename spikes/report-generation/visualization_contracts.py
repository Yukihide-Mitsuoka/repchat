...
CHART_RESULT_ROLE_CONTRACTS = {
    ...
    "line": ("time_value", "metric_value"),
    "multi_line": ("time_value", "metric_*"),
    "area": ("time_value", "metric_value"),
    "stacked_area": ("time_value", "metric_*"),
    "percent_stacked_area": ("time_value", "metric_*"),
    "histogram": ("bin_start", "frequency"),
    "donut": ("category", "metric_value"),
    "calendar_heatmap": ("time_value", "metric_value"),
    ...
    "sparkline_table": ("category", "time_value", "metric_value"),
    ...
    "annotated_line": ("time_value", "annotation_label", "metric_value"),
    "sparkline": ("time_value", "metric_value"),
