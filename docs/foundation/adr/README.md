...
| [0023](0023-minimize-consumer-root-with-versioned-foundation.md) | Minimize the consumer root while keeping a versioned Foundation | root ownership, optional capabilities, organization policy, template inheritance | proposed | 2026-09-23 |
