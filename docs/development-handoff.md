...
| 項目 | 現在地 |
|------|--------|
| 作業 | [Issue #323](https://github.com/Yukihide-Mitsuoka/repchat/issues/323) — 単一グラフの回遊設問で3〜6ページのdepth変更を専用契約として保持し、停止理由を進行欄上部へ表示する |
...
| 条件 | 次の作業 | 先に読む正本 |
|------|----------|--------------|
| 現在のデモ阻害 | [#323 custom navigation depth](https://github.com/Yukihide-Mitsuoka/repchat/issues/323)。3〜6ページの回遊指定を専用契約として扱い、範囲外はクラウド呼出し前に拒否する | [デモ手順](demo.md)、[トラブルシューティング](troubleshooting/live-demo.md)、`live_demo.py` |
...
1. **現在:** [Issue #323](https://github.com/Yukihide-Mitsuoka/repchat/issues/323)で単一グラフの回遊depth変更を専用契約として保持し、4ページedgeと停止理由UIを固定テストで確認する。実Vertex AI、実BigQueryは行わない。
