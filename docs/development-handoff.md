...
[Issue #865](https://github.com/Yukihide-Mitsuoka/repchat/issues/865)では、fake providerで実際のmanifest runnerと
成果物writerまで通し、成功・停止時のファイルと計測値を検証します。実provider commandと公式fixtureの
独立reviewは後続です。
