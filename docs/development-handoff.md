...
[PR #825](https://github.com/Yukihide-Mitsuoka/repchat/pull/825)を作成済みです。
このsliceの`make format`、`make lint`、`make test-unit`、`make test`と必須CI checks 13件は成功し、merge待ちです。
残るplanning、SQL生成、meterの安全な基盤例外は後続sliceです。
...
| 順序 | 作業 | 完了条件・次への移行条件 |
|---:|---|---|
| 1 | [#788](https://github.com/Yukihide-Mitsuoka/repchat/issues/788)の実評価前の評価契約強化 | 型付きSQL診断、case／capability／描画の合格gate、各stageの未知例外伝播、[#820](https://github.com/Yukihide-Mitsuoka/repchat/issues/820)／[PR #821](https://github.com/Yukihide-Mitsuoka/repchat/pull/821)の基盤障害run／bundle契約はmerge済み。[#822](https://github.com/Yukihide-Mitsuoka/repchat/issues/822)／[PR #823](https://github.com/Yukihide-Mitsuoka/repchat/pull/823)のrenderer起動失敗・timeoutも2026-09-23にmerge済み。[#824](https://github.com/Yukihide-Mitsuoka/repchat/issues/824)／[PR #825](https://github.com/Yukihide-Mitsuoka/repchat/pull/825)でpreflightの安全な型付き基盤障害を接続し、必須CI checks 13件が成功、merge待ち。その後、planning、SQL生成、meterの安全な基盤例外を小さいPRで接続する。attempt状態機械の全面再設計は行わない。完了後に公式fixtureと実行commandへ進む |
