...
1. **現在:** [Issue #364](https://github.com/Yukihide-Mitsuoka/repchat/issues/364)で、dashboard build成功後の右pane自動close、小型「AIに相談」ランチャー、下書き保持、keyboard復帰を固定応答とbrowserで検証する。実Vertex AI・BigQueryは実行しない。
