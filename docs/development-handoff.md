...
| 2 | [#791](https://github.com/Yukihide-Mitsuoka/repchat/issues/791)のbaseline主導SQL精度改善 | PR #867〜#869、#871、#873、#875はmerge済み。PR #876で診断runの認可外SQL拒否をfakeで検証してレビュー中。全段階の成功、対抗fixture、baselineは未完了。再現した原因に対応する対象非依存の改善だけを比較する |
