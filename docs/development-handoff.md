...
| デモ準備 | [PR #197](https://github.com/Yukihide-Mitsuoka/repchat/pull/197)は2026-07-30にmerge済み。`make demo-live PROJECT=<project>`で参加者が日本語を入力し、生成SQLとBigQuery結果のグラフを同じ画面で確認できる。既存venvの依存欠落は[PR #218](https://github.com/Yukihide-Mitsuoka/repchat/pull/218)、venv判定と費用表示は[PR #225](https://github.com/Yukihide-Mitsuoka/repchat/pull/225)、ページ全体を停止させるJavaScript構文エラーと不明瞭な進捗表示は[PR #227](https://github.com/Yukihide-Mitsuoka/repchat/pull/227)で修正済み。2026-08-02の実行で自然言語からSQLとデータが返ることをオーナーが確認したが、棒グラフのDOM操作エラーが判明したため[Issue #228](https://github.com/Yukihide-Mitsuoka/repchat/issues/228) / [PR #229](https://github.com/Yukihide-Mitsuoka/repchat/pull/229)で修正中。固定レスポンスではSVG、棒、ラベル、完了表示を実ブラウザで確認済み。修正後の費用を伴うVertex AI・BigQuery再実行は未確認 |
