...
記録します。現在は[PR #759](https://github.com/Yukihide-Mitsuoka/repchat/pull/759)で、review fixtureから参照SQL・期待結果・capabilityを除外し、
