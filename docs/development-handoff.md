...
記録します。現在は`feat/188-build-execution-manifest`で、review fixtureから参照SQL・期待結果・capabilityを除外し、
認可scope・質問・計画runだけをruntimeへ渡すexecution manifestを実装しています。公式fixture、独立reviewと実値照合、
