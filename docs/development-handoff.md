...
[Issue #862](https://github.com/Yukihide-Mitsuoka/repchat/issues/862)／
[PR #863](https://github.com/Yukihide-Mitsuoka/repchat/pull/863)で、BigQueryとVertexのbudget adapterを
同じruntime meter・manifest runnerに接続し、run間の未精算予約を拒否する変更は2026-09-25にmerge済みです。
...
[Issue #791](https://github.com/Yukihide-Mitsuoka/repchat/issues/791)の最初のsliceは
[PR #867](https://github.com/Yukihide-Mitsuoka/repchat/pull/867)で2026-09-26にmerge済みです。実行後の品質run不一致を
...
[PR #869](https://github.com/Yukihide-Mitsuoka/repchat/pull/869)で診断側の契約artifact・scope snapshot・独立review記録の照合をレビュー中です。実際のcontract使用はfile照合だけでは未証明です。
...
| 2 | [#791](https://github.com/Yukihide-Mitsuoka/repchat/issues/791)のbaseline主導SQL精度改善 | [PR #867](https://github.com/Yukihide-Mitsuoka/repchat/pull/867)のpost-run不一致原因reviewと[PR #868](https://github.com/Yukihide-Mitsuoka/repchat/pull/868)の通常・診断evidence offline比較はmerge済み。[PR #869](https://github.com/Yukihide-Mitsuoka/repchat/pull/869)の診断contract review記録・artifact照合はレビュー中。実行時利用証明、対抗fixture、baselineは未完了。再現した原因に対応する対象非依存の改善だけを比較する |
