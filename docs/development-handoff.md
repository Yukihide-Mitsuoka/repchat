...
| 2 | [#791](https://github.com/Yukihide-Mitsuoka/repchat/issues/791)のbaseline主導SQL精度改善 | PR #867〜#869と#871はmerge済み。PR #873で診断preflightを計測・予算付きrunnerへ接続してレビュー中。planning成功後の全段階での利用証明、対抗fixture、baselineは未完了。再現した原因に対応する対象非依存の改善だけを比較する |
